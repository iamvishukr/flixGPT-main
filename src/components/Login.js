...
import {
  checkValidEmail,
  checkValidPassword /*checkValidName*/,
} from "../utils/Validate";
import {
  ...
  return (
    <div className="">
      ...
      <form
        ...
        className="w-3/12 p-12 absolute my-36 mx-auto right-0 left-0 bg-black text-white bg-opacity-80"
      >
        <h1 className="font-bold text-3xl p-2 -mx-2 my-4">
        ...
        {!isSignInForm && (
          <input
            ...
            className="p-2 my-2 w-full bg-transparent border border-gray-400 rounded-sm"
          />
        )}
        ...
        <button
          className="p-2 my-2 bg-red-600 hover:bg-red-700 hover:cursor-pointer w-full rounded-sm"
        ...
        {isSignInForm && (
          <button className="p-2 my-2 bg-gray-200 bg-opacity-30 w-full rounded-sm">
            Use a sign-in code
          </button>
        )}
        ...
        <span className="flex ">
          <p className="p-2 my-2 text-md">
            {isSignInForm ? "New to flixGPT?" : "Already Registered? "}
          </p>
          <p
            className="p-2 my-2 text-gray-300 cursor-pointer hover:underline font-bold "
