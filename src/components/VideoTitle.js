...
const VideoTitle = ({title, overview}) => {
  return (
    <div className='pt-36 translate-y-28 px-12 absolute text-white bg-gradient-to-r from-black w-screen aspect-video '>
        <h1 className='text-4xl pl-0 font-bold'>{title}</h1>
        <p className='py-6 text-lg w-1/3 text-white opacity-60'>{overview}</p>
